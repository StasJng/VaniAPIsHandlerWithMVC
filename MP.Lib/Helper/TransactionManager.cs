...
namespace MP.Lib.Helper
{
    public class TransactionManager : ITransactionManager
    {
        ...
        {
            return Instance("localsql");
        }

        public static ITransactionManager InstanceReport()
        {
            return Instance("reportsql");
        }

        public static ITransactionManager InstanceVas()
        {
            return Instance("localsqlVas");
        }

        public static ITransactionManager InstanceBlog()
        {
            return Instance("localsqlgaladay");
        }
